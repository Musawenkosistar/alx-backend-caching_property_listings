...
SECRET_KEY = 'django-insecure-l=up#dj3_^vr*1v%)j=06@oxre&i8!3)v7p8tm9(nfgw26!(nk'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'alx-backend-caching_property_listings',
        'USER': 'alx-backend-caching_property_listings',
        'PASSWORD': 'postgres',
        'HOST': 'localhost',
        'POST': '5433:5432'
    }
